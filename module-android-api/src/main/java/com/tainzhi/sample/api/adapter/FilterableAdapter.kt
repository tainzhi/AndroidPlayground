 ...
 * @description:
 */
class FilterableAdapter(private val mContext: Context, list: MutableList<String>) :
    RecyclerView.Adapter<FilterableAdapter.MyViewHolder>(), Filterable {
    private var mList: MutableList<String> = arrayListOf()
    private var mOriginalList: MutableList<String> = ArrayList()
