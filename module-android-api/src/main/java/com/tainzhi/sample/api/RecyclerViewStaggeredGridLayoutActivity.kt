...
class RecyclerViewStaggeredGridLayoutActivity : AppCompatActivity(), RecyclerView.RecyclerListener {
    ...
    override fun onViewRecycled(holder: RecyclerView.ViewHolder) {
        Log.d("qfq", "position=" + holder.adapterPosition + ", height=" + recyclerView!!.height)
    }
}